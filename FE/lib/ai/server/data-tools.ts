...
registerTool({
  ...
  describe: (ctx: AiToolContext) => {
    ...
    return (
      ...
      "품명(name) · 사양(spec) · 규격(size)은 서로 다른 속성이다. 사용자가 「GAS SPRING 1500-80-MH」 처럼 한 줄로 붙여 말해도 품명은 GAS SPRING, 규격은 1500-80-MH 다 — " +
      "붙인 문장을 통째로 한 속성에 걸지 말고 낱말을 나눠 각 속성에 건다. contains 가 0건이면 낱말을 나눠(품명만 · 규격만) 다시 시도하고, 그래도 없을 때만 「없다」고 답한다.\n" +

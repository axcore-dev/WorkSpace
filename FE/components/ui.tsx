...
const FIELD_FORM =
  "rounded-lg border text-slate-900 placeholder:text-slate-400 transition-colors focus:outline-2";
const FIELD_SHAPE = `w-full ${FIELD_FORM}`;
...
/**
 * 폭을 내용에 맞추는 변형 — 필터 드롭다운처럼 한 줄에 여러 개 놓을 때.

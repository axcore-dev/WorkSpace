...
export const MODULE_PAGES: Record<string, ModulePageData> = {
  ...
  inventory: {
    stats: [
      { label: "현재 재고 자산", value: "18.6억원", sub: "원자재 7.2 · 재공 4.1 · 완제품 7.3" },
      {
        label: "안전 재고 미달",
        value: "3품목",
        delta: "+1",
      ...
      },
      {
        ...
        deltaTone: "amber",
        sub: "금일 합격 3 · 반품 1",
        cta: { label: "검사하기", tabId: "receiving" },
      },
      {
        label: "금일 입출고",
        value: "6건",
        sub: "입고 2 · 출고 3 · 조정 1",
        cta: { label: "이력 보기", tabId: "movements" },
      },
    ],
    tabs: [
      {
        ...
        actions: ["filter", "create"],
        description:
          "품목 분류·사양·규격을 기준정보로 등록하고, 현장에서 쓰던 옛 표기를 별칭으로 매핑합니다. 입출고는 이 목록에서 선택해 기록합니다.",
        table: {
          columns: ["품목 코드", "품목 분류", "사양", "상세 규격", "단위", "옛 표기 (별칭)", "상태"],
          rows: [
            ["ITM-AL-6061", "ALUMINUM", "T6", "6061-20T", "kg", "알루미늄 합금 6061", { badge: "사용", tone: "green" }],
            ["ITM-SS-0304", "STAINLESS", "2B", "304-1.5t", "kg", "스테인리스강 304", { badge: "사용", tone: "green" }],
            ["ITM-BR-C360", "BRASS", "C3604", "Ø12", "kg", "황동봉 C3604", { badge: "사용", tone: "green" }],
            ["ITM-BRG-608", "BEARING", "ZZ", "608-8×22×7", "EA", "베어링 608ZZ", { badge: "사용", tone: "green" }],
            ["ITM-SCR-M04", "SCREW", "SUS304", "M4×12", "EA", "육각볼트 M4×12", { badge: "사용", tone: "green" }],
            ["—", "CUTTING OIL", "—", "20L", "통", "절삭유 / 절삭유20L", { badge: "별칭 미매핑", tone: "amber" }],
          ],
        },
        note: "옛 표기가 매핑되지 않은 품목은 입출고 등록 시 서로 다른 품목으로 갈라져 재고가 어긋납니다. 매핑을 마친 뒤 사용하세요.",
      },
      {
        id: "stock",
        label: "현재 재고",
        actions: ["filter", "export"],
        description:
          "현재 재고는 따로 저장하는 값이 아니라 기초 재고에 입출고를 누적해 산출합니다. 어긋나면 원장을 먼저 확인하세요.",
        table: {
          columns: ["품목", "창고", "기초 재고", "입고", "출고", "현재 재고", "안전 재고", "상태"],
          rows: [
            ["알루미늄 합금 6061", "원자재 1창고", "3,900 kg", "+1,500", "−1,980", "3,420 kg", "4,000 kg", { badge: "발주 필요", tone: "red" }],
            ["스테인리스강 304", "원자재 1창고", "4,180 kg", "+1,500", "−500", "5,180 kg", "3,500 kg", { badge: "정상", tone: "green" }],
            ["베어링 608ZZ", "부품 창고", "4,240 EA", "+5,000", "−1,000", "8,240 EA", "10,000 EA", { badge: "발주 진행중", tone: "amber" }],
            ["황동봉 C3604", "원자재 2창고", "1,900 kg", "+0", "−780", "1,120 kg", "—", { badge: "기준 미설정", tone: "slate" }],
            ["절삭유 20L", "부자재 창고", "42 통", "+30", "−36", "36 통", "40 통", { badge: "기준 미달", tone: "amber" }],
          ],
        },
        note: "현재 재고 = 기초 재고 + 입고 − 출고. 실사에서 차이가 나면 원장을 고치지 않고 조정 이력으로 남긴 뒤 기초 재고를 갱신합니다.",
      },
      {
        id: "safety",
        label: "안전 재고",
        actions: ["filter", "export"],
        description: "품목별 안전 재고 기준을 등록하고 미달 품목과 최적 주문량을 산출합니다.",
        table: {
        ...
        note: "기준이 미설정인 품목은 부족 수량 자동 계산과 발주 권고에서 제외됩니다. 기준 미달 품목은 경영지원 > 구매 관리로 발주 권고가 자동 연계됩니다.",
      },
      {
        id: "receiving",
        label: "입고·수입검사",
        actions: ["filter", "create"],
        description:
          "발주 대비 입고 수량을 등록하고 외관·치수 검사 결과를 기록합니다. 합격 수량만 재고에 반영됩니다.",
        table: {
          columns: ["입고번호", "발주번호", "품목", "발주", "입고", "외관", "치수", "검사자", "판정"],
          rows: [
            ["GR-2607-012", "PR-2606-087", "스테인리스강 304", "1,500 kg", "1,500 kg", "합격", "합격", "이수진", { badge: "재고 반영", tone: "green" }],
            ["GR-2607-011", "PR-2607-011", "베어링 608ZZ", "5,000 EA", "5,000 EA", "합격", "검사중", "김태리", { badge: "검사중", tone: "amber" }],
            ["GR-2607-010", "PR-2607-009", "절삭유 20L", "30 통", "30 통", "합격", "해당없음", "박찬영", { badge: "재고 반영", tone: "green" }],
            ["GR-2607-009", "PR-2606-086", "황동봉 C3604", "800 kg", "620 kg", "합격", "합격", "이수진", { badge: "부분 입고", tone: "amber" }],
            ["GR-2607-008", "PR-2607-005", "육각볼트 M4×12", "20,000 EA", "20,000 EA", "불합격", "—", "김태리", { badge: "반품", tone: "red" }],
          ],
        },
        note: "불합격·검사중 수량은 재고에 반영되지 않습니다. 부분 입고는 미입고 잔량(180 kg)으로 남아 발주 추적에 표시됩니다.",
      },
      {
        id: "movements",
        label: "입출고 이력",
        actions: ["filter", "export"],
        description:
          "입고·출고·조정을 시간순 원장으로 기록합니다. 출고는 반드시 작업지시나 프로젝트에 귀속됩니다.",
        table: {
          columns: ["일시", "품목", "사양", "규격", "구분", "수량", "담당자", "사유 / 귀속"],
          rows: [
            ["07-02 09:40", "스테인리스강 304", "2B", "1.5t", { badge: "입고", tone: "green" }, "+1,500 kg", "오세라", "GR-2607-012 검사 합격"],
            ["07-02 08:15", "알루미늄 합금 6061", "T6", "20mm", { badge: "출고", tone: "slate" }, "−680 kg", "김하람", "WO-2607-021 정밀 샤프트"],
            ["07-02 08:02", "황동봉 C3604", "C3604", "Ø12", { badge: "출고", tone: "slate" }, "−780 kg", "김하람", "WO-2607-015 감속 기어"],
            ["07-01 16:30", "절삭유 20L", "—", "20L", { badge: "입고", tone: "green" }, "+30 통", "오세라", "GR-2607-010 검사 합격"],
            ["07-01 14:20", "알루미늄 합금 6061", "T6", "20mm", { badge: "조정", tone: "amber" }, "−12 kg", "오세라", "재고 실사 차이 반영"],
            ["07-01 11:05", "육각볼트 M4×12", "SUS304", "M4×12", { badge: "출고", tone: "slate" }, "−1,200 EA", "박서준", "WO-2607-019 브래킷"],
          ],
        },
        note: "원장은 덧붙이기만 하고 지우지 않습니다. 실사 차이는 조정 행으로 남겨 언제 무엇이 어긋났는지 추적할 수 있습니다.",
      },
    ],
  },
